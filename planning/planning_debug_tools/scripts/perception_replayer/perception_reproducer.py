...
class PerceptionReproducer(PerceptionReplayerCommon):
    def __init__(self, args):
        ...
        self.prev_objects_msg, self.prev_traffic_signals_msg, self.prev_pointcloud_msg = (
    ...
    def on_timer(self):
        ...
        if not repeat_flag:
            ...
            objects_msg, traffic_signals_msg, pointcloud_msg = self.find_topics_by_timestamp(
                pose_timestamp
            )
            ...
            pointcloud_msg = self.prev_pointcloud_msg
        ...
        pointcloud_msg = pointcloud_msg if pointcloud_msg else self.prev_pointcloud_msg
        if self.args.pointcloud and pointcloud_msg:
            self.prev_pointcloud_msg = pointcloud_msg
            pointcloud_msg.header.stamp = timestamp_msg
            self.pointcloud_pub.publish(pointcloud_msg)
